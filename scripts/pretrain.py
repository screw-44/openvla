...
class PretrainConfig:
    ...
    # Tracking Parameters
    trackers: Tuple[str, ...] = ("wandb",)                          # Only use trackio (aliased as wandb)
    wandb_project: str = "onyx-vlms"                                # Trackio project name
    wandb_entity: Optional[str] = "stanford-voltron"                # Trackio entity name
