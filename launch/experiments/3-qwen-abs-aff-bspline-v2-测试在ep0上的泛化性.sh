...
# 测试特定配置
# ============================================================================
EXPERIMENT_NAME='1-qwen25-abs_aff_uniform_bspline_v2_test_converge_on_ep0'
...
TRAJECTORY_COMPRESSION="abs_aff_uniform_bspline"  # 显式设置轨迹压缩方法
...
# 项目配置
PROJECT="useless_test" # 测试就放在useless这里
...
TRAIN_CMD="torchrun --standalone --nnodes 1 --nproc-per-node ${NUM_GPUS} scripts/train.py \
    ...
    vla.trajectory.converter_type=abs_aff_bspline_textualize \
