#!/usr/bin/env bash
# ============================================================================
# 实验：Fix Freq Bining + EOS Token 训练
# 日期: 2025-12-17
# 目标: 使用 fix_freq_bining 压缩方法 + EOS token 实现变长轨迹生成
# ============================================================================
...
# 实验特定配置
# ============================================================================
EXPERIMENT_NAME="fixfreq_bining_eos_12_17"
...
# 轨迹压缩方法
COMPRESSION_METHOD="fix_freq_bining"
...
# ============================================================================
echo "============================================"
echo "实验: Fix Freq Bining + EOS Token 训练"
echo "============================================"
...
echo ""
echo "实验目标:"
echo "  1. 使用 fix_freq_bining 均匀采样压缩方法"
echo "  2. 实现变长轨迹生成 (no padding, 使用 EOS token)"
echo "  3. 测试时间优先的 token 顺序 (t0_d0, t0_d1, ..., t1_d0, ...)"
echo "  4. 在所有 LIBERO tasks 上训练并验证效果"
echo ""
echo "技术特点:"
echo "  - 采样: 均匀采样到 target_length 个点"
echo "  - 截断: 根据 frame_percentage 动态截断"
echo "  - 结束: 添加 EOS token 标记轨迹结束"
echo "  - 对比: 与 fix_freq_uniform_bspline 对比 (sampling vs fitting)"
echo "============================================"
...
echo "  3. 评估模型在 LIBERO 仿真环境中的表现"
echo "  4. 分析不同时间步 (t0, t0-t5) 的准确率"
echo "============================================"
